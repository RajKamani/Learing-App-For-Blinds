...
public class TotalB_chap_act extends AppCompatActivity {
    TextToSpeech t1;
    String tts;
    int ch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_b_chap_act);
        ...
        switch (ch1) {
            case 1:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        speechtotext();
                        Intent i1 =new Intent(TotalB_chap_act.this,displayText.class);
                        bundle.putString("file","1.txt");
                        i1.putExtras(bundle);
                        startActivity(i1);
                    }
                }, 5500);
            ...
            case 2:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        speechtotext();
                        Intent i2 =new Intent(TotalB_chap_act.this,displayText.class);
                        bundle.putString("file","2.txt");
                        i2.putExtras(bundle);
                        startActivity(i2);
                    }
                }, 5500);
            ...
            case 3:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        speechtotext();
                        Intent i3 =new Intent(TotalB_chap_act.this,displayText.class);
                        bundle.putString("file","3.txt");
                        i3.putExtras(bundle);
                        startActivity(i3);
                    }
                }, 5500);
            ...
            case 4:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        speechtotext();
                        Intent i4 =new Intent(TotalB_chap_act.this,displayText.class);
                        bundle.putString("file","4.txt");
                        i4.putExtras(bundle);
                        startActivity(i4);
                    }
                }, 5500);
            ...
            case 5:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        speechtotext();
                        Intent i5 =new Intent(TotalB_chap_act.this,displayText.class);
                        bundle.putString("file","5.txt");
                        i5.putExtras(bundle);
                        startActivity(i5);
                    }
                }, 5500);
