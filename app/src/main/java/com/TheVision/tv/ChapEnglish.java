...
public class ChapEnglish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chap_english);
        ...
        btn_1.setOnClickListener( new DoubleClick(new DoubleClickListener() {
            ...
            public void onDoubleClick(View view) {
                ...
                Intent i1 =new Intent(ChapEnglish.this,displayText.class);
                b1.putString("file","1.txt");
                i1.putExtras(b1);
                startActivity(i1);
